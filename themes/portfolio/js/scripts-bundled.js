...
(function($) {
    ...
    function fixedNav() {
        $(".js--header__text").waypoint(function(direction) {
            if (direction == "down") {
...
(function($) {
    ...
    function cardFocus() {
        $(document).on("focus", ".card", function() {
            $(this).find(cardfront).addClass("rotate-180");
            $(this).find(cardback).addClass("rotate0");
        });
        card.focusout(function() {
            $(this).find(cardfront).removeClass("rotate-180");
            $(this).find(cardback).removeClass("rotate0");
        });
    }
